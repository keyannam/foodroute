...
from foodrouteapp.forms import UserForm, RestaurantForm, UserFormForEdit, MealForm
from django.contrib.auth import authenticate, login

from django.contrib.auth.models import User
from foodrouteapp.models import Meal, Order
...
def restaurant_order(request):
    if request.method == "POST":
        order = Orders.objects.get(id = request.POST["id"], restaurant = request.user.restaurant)
